# Generated by Django 4.1.3 on 2022-11-03 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Иконка приемущества', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tickets.benefiticon', verbose_name='ticket_benefit_icon')),
            ],
            options={
